...
const socialLinks = [
    ...
    },
    {
      ...
      icon: <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
const Contact = () => {
  return (
    ...
    >
        <div className="ambient-glow-sky -bottom-20 -left-20" aria-hidden="true" />
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch relative z-10">
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({ href, label, icon }, key) => (
                        <a
                            ...
                            place-items-center ring-inset ring-1 
                            ring-zinc-700/60 rounded-xl bg-zinc-900/80
                            transition-all duration-200 hover:bg-amber-400
                            hover:text-zinc-950 active:bg-amber-500 reveal-up
            ...
            <form 
                action="https://getform.io/f/bkkygkxb"
                method="POST"
